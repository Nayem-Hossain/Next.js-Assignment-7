        ...
        <AppLayout>
            <div>
                ...
                <div className="flex justify-center">
                    <input onChange={(e) => setInputAmount(e.target.value)} value={inputAmount} type="text" placeholder="Input your expense..." className="input input-bordered w-full max-w-xs" />
